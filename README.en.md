...
**Turn the M5Stack PaperColor C151 into a quiet, low-power physical Pulse terminal for LLMs.**
...
[简体中文](README.md) · [Quick start](#1-clone-and-build-the-firmware) · [Home Assistant](docs/home-assistant.md) · [Cloudflare / MCP](docs/cloudflare.md) · [Issues](https://github.com/yanyichiang/papercolor-pulse/issues)

</div>

---

PaperColor Pulse turns an M5Stack PaperColor C151 into a low-power, three-page LLM Pulse display.
...
**Let agents keep working while only the important things remain in physical space.**
